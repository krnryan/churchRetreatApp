<?php
    ...
    $data = [];
    $result = mysqli_query($con, "SELECT * FROM announcement WHERE id=" . $_GET["id"]);
    $i = 0;
...
?>
    ...
    <body>
        ...
        <div class="container topMargin">
            <div style="text-align: center;" class="jumbotron noticePgBody">
                <h3><?php echo $data[0]["title"]; ?></h3>
                <h5><?php echo $data[0]["content"]; ?></h5>
            </div>
        </div>
